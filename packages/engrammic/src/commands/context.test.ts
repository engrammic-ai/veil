...
import type { ContextWindow, ContextBudget, ContextItem } from "../types.ts";
...
describe("renderContextCommand", () => {
  ...
  it("renders loaded items correctly", () => {
    const item = makeItem({ id: "aabbccdd11223344", type: "episodic", content: "Episodic memory item content here", pinned: true });
