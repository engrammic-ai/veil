...
export const BUILTIN_SLASH_COMMANDS: ReadonlyArray<BuiltinSlashCommand> = [
	...
	{ name: "clear", description: "Clear context and start fresh (alias for /new)" },
	{ name: "compact", description: "Compact context (Veil eviction; use '/compact full' for LLM summarization)" },
